...
<body>
    ...
    <!-- MODALE DE DÉTAIL PROFESSIONNELLE -->
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header modal-detail-header">
                    <div>
                        <h5 class="modal-title fs-4 fw-bold" id="detailNumero">#DEM-2026-001</h5>
                ...
                <div class="modal-footer bg-white border-0">
                    ...
                    <button type="button" class="btn btn-success" onclick="approveFromModal()" id="modalApproveBtn">
                        <i class="fas fa-check-circle me-2"></i>Approuver
                    </button>
                    <button type="button" class="btn btn-danger" onclick="rejectFromModal()" id="modalRejectBtn">
    ...
    <script>
        ...
        const demandesDetails = {
            1: {
                ...
                profilDetenu: "Utilisateur standard",
            ...
            2: {
                id: "002",
                numero: "DEM-2026-002",
                dateSoumission: "11/03/2026 09:15",
                statut: "En attente",
                nomComplet: "Marie Martin",
                service: "RH",
                email: "marie.martin@email.com",
                profilDetenu: "Consultation SIRH",
                profilDemande: "Accès SIRH",
                cumulable: "Non",
                motifs: ["Affectation", "Retour de congés"],
                observation: "Mutation vers le service paie",
            ...
            5: {
                ...
                profilDemande: "Accès VPN",
                cumulable: "Oui",
                motifs: ["Départ/Retour de congés"],
                observation: "Besoin d'accès VPN pour télétravail",
                typeHabilitation: "Temporaire",
                messagerie: "Non",
                periode: "08/03/2026 au 08/04/2026",
                suspension: "Aucune",
                piecesJointes: [],
                traitement: null
            }
        ...
        // Fonction viewDemande améliorée
        function viewDemande(id) {
            currentDemandeId = id;
            const d = demandesDetails[id] || demandesDetails[1];
            ...
            if (d.statut === 'En attente') {
                ...
                statutBadge.className = 'badge bg-white text-dark p-3';
            ...
            // Gérer l'affichage des boutons Approuver/Rejeter selon le statut
            if (d.statut !== 'En attente') {
        ...
        // Fonctions pour les actions depuis la modale
        function approveFromModal() {
            bootstrap.Modal.getInstance(document.getElementById('detailModal')).hide();
            setTimeout(() => {
                showApproveModal(currentDemandeId, 
                                document.getElementById('detailNomComplet').textContent, 
                                document.getElementById('detailProfilDemande').textContent);
            }, 500);
        }
        ...
        function rejectFromModal() {
            bootstrap.Modal.getInstance(document.getElementById('detailModal')).hide();
            setTimeout(() => {
                showRejectModal(currentDemandeId, 
                                document.getElementById('detailNomComplet').textContent, 
                                document.getElementById('detailProfilDemande').textContent);
            }, 500);
        }
        
        // Fonctions pour les modals (inchangées)
